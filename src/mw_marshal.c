...
void
mw_marshal_VOID__BOOLEAN_POINTER_POINTER (GClosure     *closure,
                                          GValue       *return_value,
...
{
  typedef void (*GMarshalFunc_VOID__BOOLEAN_POINTER_POINTER) (gpointer     data1,
                                                              gboolean     arg_1,
                                                              gpointer     arg_2,
                                                              gpointer     arg_3,
                                                              gpointer     data2);
  register GMarshalFunc_VOID__BOOLEAN_POINTER_POINTER callback;
  ...
  callback = (GMarshalFunc_VOID__BOOLEAN_POINTER_POINTER) (marshal_data ? marshal_data : cc->callback);
...
/* VOID:UINT (marshal.list:8) */

/* VOID:UINT,UINT,POINTER (marshal.list:9) */
void
mw_marshal_VOID__UINT_UINT_POINTER (GClosure     *closure,
                                    GValue       *return_value,
                                    guint         n_param_values,
                                    const GValue *param_values,
                                    gpointer      invocation_hint,
...
/* VOID:POINTER (marshal.list:11) */

/* VOID:POINTER,UINT (marshal.list:12) */
void
...
/* BOOLEAN:POINTER (marshal.list:15) */
void
